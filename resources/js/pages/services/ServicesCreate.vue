        ...
        <b-form>
          <b-form-group label="Service Name" label-for="service_name">
            <b-form-input
              ...
              @blur="checkIsValid($v.service.name, $event)"
              placeholder="Enter name"
            ></b-form-input>
            <b-form-invalid-feedback id="input-live-feedback">
              This field
              <span v-if="!$v.service.name.required">is required and</span>cannot be more than 50 characters
          ...
          <b-form-group label="Service Description" label-for="service_description">
            ...
            <b-form-invalid-feedback id="input-live-feedback">
              This field
              <span v-if="!$v.service.description.required">is required and</span>cannot be more than 50 characters
            </b-form-invalid-feedback>
          </b-form-group>
            ...
            <b-col md="6">
              <b-form-group label="Service Rate" label-for="service_rate">
                <b-form-input
                  ...
                  name="service_rate"
                  required
                  autocomplete="service_rate"
                  v-model="$v.service.cost.$model"
                  :state="validateState('cost')"
                  @blur="checkIsValid($v.service.cost, $event)"
